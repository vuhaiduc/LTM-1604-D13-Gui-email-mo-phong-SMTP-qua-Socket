...
public class ReceiverLoginUI extends JFrame {
    private JTextField usernameField;
    private JPasswordField passwordField;
    private JLabel statusLabel;

    public ReceiverLoginUI() {
        setTitle("Đăng nhập - Người nhận");
        setSize(450, 400);
        ...
        card.setBackground(new Color(245, 245, 245, 230)); // trắng hơi trong suốt
        ...
        btnPanel.setBackground(new Color(0, 0, 0, 0)); // trong suốt để không che gradient
        ...
        try (Socket socket = new Socket("localhost", ServerMain.AUTH_PORT);
            ...
            if (resp instanceof String && "success".equals(resp)) {
                ...
                SwingUtilities.invokeLater(() -> {
                    new ReceiverEmailUI(user).setVisible(true);
                    dispose();
                });
            } else {
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ReceiverLoginUI().setVisible(true));
    }
}
